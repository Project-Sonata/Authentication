...
import static com.odeyalo.sonata.authentication.common.ErrorDetails.of;
...
public class GlobalExceptionHandlerController {
    public static final ErrorDetails MFA_METHOD_DOES_NOT_SUPPORTED = of("invalid_mfa_method",
            "This method does not supported", "Use valid MFA method");

    public static final ErrorDetails INVALID_SESSION = of("invalid_session",
            "Login cannot be performed since login session is malformed", "Try to login using credentials.");

    public static final ErrorDetails MISSING_CONFIRMATION_CODE_VALUE = of("missing_confirmation_code",
